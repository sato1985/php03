...
//２．データ登録SQL作成d
$stmt   = $pdo->prepare("SELECT * FROM kadai_an_table WHERE id=:id"); //SQLをセット
  ...
  <div class="jumbotron">
   <fieldset>
    <legend>ペットフードのアンケート</legend>
     ...
     <label>ペットの悩み<textArea name="naiyou" rows="4" cols="40"><?=$row["naiyou"]?></textArea></label><br>
     <!-- idを隠して送信 -->
